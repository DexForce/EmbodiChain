...
.. currentmodule:: embodichain.training.rl
...
The training script (``train.py``) is located in ``embodichain/training/rl/``:

.. dropdown:: Code for train.py
   :icon: code

   .. literalinclude:: ../../../embodichain/training/rl/train.py
      :language: python
      :linenos:
...
1. Create a new algorithm class in ``embodichain/training/rl/algo/``
...
.. code-block:: python
   ...
   from embodichain.training.rl.algo import BaseAlgorithm, register_algo
...
.. code-block:: python
   ...
   from embodichain.training.rl.models import register_policy, Policy
