...
`embodichain.lab.sim.motion.workspace`. See [Runtime Workspace Sampling](runtime.md)
...
```python
from embodichain.lab.sim.motion.workspace.configs import VisualizationConfig
