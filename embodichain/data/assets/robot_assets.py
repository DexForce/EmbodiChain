...
class CobotMagicArm(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "CobotMagicArmV2.zip",
...
class RidgeBack(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "RidgeBack.zip",
...
class UnitreeH1(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "UnitreeH1.zip",
...
class ABB(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "ABB.zip",
...
class Motoman(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "Motoman.zip",
...
class KUKA(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "KUKA.zip",
...
class Fanuc(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "Fanuc.zip",
...
class UniversalRobots(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "UniversalRobots.zip",
...
class Rokae(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "Rokae.zip",
...
class Franka(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "Franka.zip",
...
class Agile(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "Agile.zip",
...
class Hans(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "Hans.zip",
...
class Aubo(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "Aubo.zip",
...
class RainbowY1(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "RainbowY1.zip",
