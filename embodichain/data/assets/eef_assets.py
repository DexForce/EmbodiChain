...
class DH_PGC_140_50(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "DH_PGC_140_50.zip",
...
class DH_PGI_140_80(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "DH_PGI_140_80.zip",
...
class DH_PGC_140_50_M(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "DH_PGC_140_50_M.zip",
...
class ZH_CTM2F110(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "ZH_CTM2F110.zip",
...
class BrainCoHandRevo1(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "BrainCoHandRevo1.zip",
...
class InspireHand(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "InspireHand.zip",
...
class Robotiq2F85(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "Robotiq2F85.zip",
...
class WheelTecFA2F(EmbodiChainDataset):
    ...
    def __init__(self, data_root: str = None):
        data_descriptor = o3d.data.DataDescriptor(
            EMBODICHAIN_DOWNLOAD_PREFIX + "WheelTecFA2F.zip",
