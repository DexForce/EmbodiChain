...
GLOBAL_INDICES = {
    ...
    **{"left_gripper_joint_{}_vel".format(i): i + 75 for i in range(5)},
    ...
    # [103, 115): dextrous hand joint positions
    **{"left_hand_joint_{}_pos".format(i): i + 103 for i in range(6)},
    **{"right_hand_joint_{}_pos".format(i): i + 109 for i in range(6)},
    # [115, 119): torso joint positions
    **{"torso_joint_{}_pos".format(i): i + 115 for i in range(4)},
    # [119, 121): head joint positions
    **{"head_joint_{}_pos".format(i): i + 119 for i in range(2)},
    "waist": 115,
    # [121, 123): head joint velocities
    **{"head_joint_{}_vel".format(i): i + 121 for i in range(2)},
    "waist_vel": 113,
    # [124, 128): reserved
}
...
def get_all_left_related_indices(including_end: bool = True):
    if including_end:
        return np.arange(50, 128, step=1)
    else:
        return np.arange(50, 100)


def get_all_right_related_indices():
