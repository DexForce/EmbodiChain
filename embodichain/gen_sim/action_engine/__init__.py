...
goals become a typed semantic Task Agent, deterministic compilation lowers
that program into a coordinate-free Execution Program, and the runtime grounds
the latter only against live simulator state.
"""
