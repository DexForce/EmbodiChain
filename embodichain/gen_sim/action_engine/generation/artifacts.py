...
def artifact_paths(output_dir: str | Path) -> GeneratedConfigPaths:
    ...
    return GeneratedConfigPaths(
        ...
        task_agent=directory / TASK_AGENT_FILENAME,
        execution_program=directory / EXECUTION_PROGRAM_FILENAME,
        seed_task_graph_png=directory / SEED_TASK_GRAPH_PNG_FILENAME,
    )
...
def write_generation_artifacts(
    ...
    *,
    ...
    payloads = {
        ...
        paths.task_agent: _serialize_json(task_agent),
        paths.execution_program: _serialize_json(execution_program),
        paths.seed_task_graph_png: seed_task_graph_png,
    }
