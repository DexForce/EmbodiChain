...
ARTICULATION_SERVER_TIMEOUT_S = _getenv("ARTICULATION_SERVER_TIMEOUT_S", "30")
ARTICULATION_SERVER_TASK_TIMEOUT_S = _getenv(
    "ARTICULATION_SERVER_TASK_TIMEOUT_S", "7200"
)
ARTICULATION_SERVER_POLL_INTERVAL_S = _getenv(
