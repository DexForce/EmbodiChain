...
def load_prompt2geometry_config(config_path: Path | None = None) -> Prompt2GeometryConfig:
    ...
    llm = _mapping(_mapping(raw.get("llm"), "llm").get("openai_compatible"), "llm.openai_compatible")
