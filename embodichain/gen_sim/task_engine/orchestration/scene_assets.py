...
"""Normalize generated-scene meshes for the Task Program runtime."""
...
def normalize_scene_assets(
    ...
    Args:
        scene: Prepared scene whose runtime GLB assets should be normalized.
        output_dir: Root directory for content-addressed normalized assets.

    Returns:
        A copy of the prepared scene that references normalized runtime meshes
        and records their hashes and provenance.
    """
    sections = {
