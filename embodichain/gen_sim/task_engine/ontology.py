...
TASK_CONTRACTS: Mapping[str, TaskContract] = MappingProxyType(
    {
        ...
        "E6": _contract(
            "E6",
            "Slide a prismatic articulated part open or closed along its joint axis.",
            frozenset({"required_arm", "target_state"}),
            "articulation",
            frozenset({"slideable"}),
            "articulation_joint_near",
            scene_affordances=frozenset({"articulated", "slideable"}),
        ),
        "E7": _contract(
            "E7",
            "Open a revolute articulated door by its handle.",
            frozenset({"required_arm", "target_state"}),
            "articulation",
            frozenset({"openable"}),
            "articulation_joint_near",
            scene_affordances=frozenset({"articulated", "openable"}),
        ),
        "E8": _contract(
            "E8",
