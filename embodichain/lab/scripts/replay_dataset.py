...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Replay LeRobot dataset in EmbodiedEnv"
    )
    parser.add_argument(
        "--dataset_path",
        type=str,
    ...
    parser.add_argument(
        "--headless", action="store_true", help="Run in headless mode without rendering"
    )
    parser.add_argument(
        "--fps",
        type=int,
    ...
    parser.add_argument(
        "--save_video", action="store_true", help="Save replay as video"
    )
    parser.add_argument(
        "--video_path",
        type=str,
...
def load_lerobot_dataset(dataset_path):
    ...
    try:
        ...
        log_info(
            f"  - Total episodes: {dataset.meta.info.get('total_episodes', 'N/A')}"
        )
...
def replay_episode(
    env, dataset, episode_idx, fps=None, save_video=False, video_path=None
):
