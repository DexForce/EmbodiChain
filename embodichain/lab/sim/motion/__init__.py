...
Subpackages load on access so importing solvers during Robot initialization
...
__all__ = ["solvers", "planners", "workspace", "trajectory_augmentation"]


def __getattr__(name: str) -> ModuleType:
    """Load a public motion subpackage on first access."""
    if name in __all__:
