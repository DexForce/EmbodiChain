...
"""Semantic scene, call, profile, and effect contracts.

This package is intentionally declarative. It does not compile or execute
actions; Atomic Actions and Expert Program are the two supported action entry
points.
"""
