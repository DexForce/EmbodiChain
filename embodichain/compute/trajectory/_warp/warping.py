...
@wp.kernel
def compute_offset_key_poses_kernel(
    ...
    """Write offset keyframe poses in the solver base frame.

    Inputs and output matrices use flattened row-major storage. The output is
    a pose matrix per batch/keyframe; the caller performs IK to obtain qpos.
    """
