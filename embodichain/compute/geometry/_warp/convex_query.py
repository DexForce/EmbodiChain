...
def convex_signed_distance_kernel(
    ...
    """
    Compute the maximum halfspace value for each point and convex hull.

    With unit plane normals, non-positive values identify points inside the
    hull. Outside values are not generally the Euclidean distance to the hull.
    ...
    Returns:
        signed_distances: [n_pose, n_point, n_convex] output maximum halfspace values. Initialize as -inf before launch.
    """
