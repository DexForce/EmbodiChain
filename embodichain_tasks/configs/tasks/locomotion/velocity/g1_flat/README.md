# Unitree G1 Flat Velocity

Track planar velocity and yaw-rate commands with the Unitree G1 humanoid on flat terrain.
Gym ID: `UnitreeG1FlatRL-v1`.
...
```bash
embodichain show-task embodichain_tasks:g1_flat
embodichain run-env --gym_config embodichain_tasks/configs/tasks/locomotion/velocity/g1_flat/env.yaml
embodichain train-rl --config embodichain_tasks/configs/tasks/locomotion/velocity/g1_flat/agents/ppo.yaml
embodichain train-rl --config embodichain_tasks/configs/tasks/locomotion/velocity/g1_flat/agents/ppo.newton.yaml
```
