# Unitree H1_2 Flat Velocity

Track planar velocity and yaw-rate commands with the Unitree H1_2 humanoid on flat terrain.
Gym ID: `UnitreeH1_2FlatRL-v1`.
...
```bash
embodichain show-task embodichain_tasks:h1_2_flat
embodichain run-env --gym_config embodichain_tasks/configs/tasks/locomotion/velocity/h1_2_flat/env.yaml
embodichain train-rl --config embodichain_tasks/configs/tasks/locomotion/velocity/h1_2_flat/agents/ppo.yaml
embodichain train-rl --config embodichain_tasks/configs/tasks/locomotion/velocity/h1_2_flat/agents/ppo.newton.yaml
```
...
Check command tracking, upright posture, tilt failures and episode survival.
