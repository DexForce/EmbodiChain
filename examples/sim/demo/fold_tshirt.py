        ...
        RigidObjectCfg(
            ...
            attrs=RigidBodyPhysicsCfg(
                collision_props=NewtonCollisionPropertiesCfg(
                    collision_enabled=True, has_particle_collision=True
                ),
                material_props=NewtonRigidBodyMaterialCfg(
                    static_friction=0.5, dynamic_friction=0.5, ke=500000.0, kd=1e-06
                ),
            ),
            body_type="static",
    ...
    robot = sim.add_robot(
        RobotCfg(
            ...
            attrs=RigidBodyPhysicsCfg(
                ...
                material_props=NewtonRigidBodyMaterialCfg(
                    static_friction=0.25, dynamic_friction=0.25, ke=300000.0, kd=0.0001
                ),
            ),
