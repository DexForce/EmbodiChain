...
"""Analyze a planar slice of the DexForce W1 workspace."""
...
def main() -> None:
    """Run planar workspace analysis."""
    parser = add_demo_args(
        argparse.ArgumentParser(description="Analyze a planar W1 workspace slice.")
    )
    parser.add_argument(
        "--num_samples",
        "--num-samples",
        type=int,
        default=1500,
        help="Number of planar poses to sample.",
    )
    ...
    try:
        ...
        results = WorkspaceAnalyzer(
            ...
            config=WorkspaceAnalyzerConfig(
                ...
                reference_pose=left_arm_pose[0].cpu().numpy(),
