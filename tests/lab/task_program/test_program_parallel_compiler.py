...
from embodichain.lab.task_program.semantics.calls import Pick
...
def _compiler() -> TaskProgramCompiler:
...
def _config(program: ParallelCfg | SegmentCfg | SequenceCfg) -> TaskProgramCfg:
