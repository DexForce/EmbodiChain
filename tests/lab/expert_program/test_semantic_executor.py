...
import embodichain.lab.expert_program._semantic_executor as runtime_module
...
from embodichain.lab.expert_program._parallel_executor import ParallelSemanticExecutor
