...
_CONFIG_DIRECTORY = _REPOSITORY_ROOT / "embodichain_tasks/configs/gym/expert_program"
_TASKS = {
    "repeated_pick_place": (
...
def _config_path(task_name: str) -> Path:
    ...
    return _CONFIG_DIRECTORY / f"{task_name}.json"
...
def test_examples_have_no_importable_task_environment_modules() -> None:
    ...
    for task_name in _TASKS:
        module_name = f"embodichain_tasks.expert_program.{task_name}"
