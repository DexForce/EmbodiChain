...
from embodichain.lab.task_program.runtime.results import SemanticExecutionStatus
...
def _runtime_and_bridge() -> tuple[TaskProgramDemoBridge, _TraceAction]:
    ...
    bridge = TaskProgramDemoBridge(_CompiledTaskProgram(segment), runtime, sink, clock)
...
def test_completion_trace_preserves_every_plan_generation_as_json_metadata() -> None:
    ...
    assert metadata["task_program_id"] == "completion-audit-program"
